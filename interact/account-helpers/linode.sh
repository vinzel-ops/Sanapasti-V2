...
if [[ "$acc" == "y" ]]; then
  ...
  curl https://api.linode.com/v4/support/tickets -H "Content-Type: application/json"  -H "Authorization: Bearer $token" -X POST -d '{ "description":  "Hello! I have recently installed the sanapasti framework http://github.com/pry0cc/sanapasti and would like to request an image increase to 25GB please for the purposes of bulding the packer image. Thank you have a great day! - This request was automatically generated by Axiom", "summary": "Image increase request to 25GB for Axiom" }' 
  echo ""   
  echo -e "${Green}Opened a ticket with Linode support! Please wait patiently for a few hours and when you get an increase run 'sanapasti-build'!${Color_Off}"
