...
echo -e "${BGreen}Creating an Sanapasti Security Group: ${Color_Off}"
aws ec2 delete-security-group --group-name sanapasti > /dev/null 2>&1
sc="$(aws ec2 create-security-group --group-name sanapasti --description "SANAPASTI SG")"
